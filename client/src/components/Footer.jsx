...
const Footer = () => {
  return (
    <footer className="px-2 pt-8 sm:px-6 md:px-16 lg:px-36 w-full">
      <div className="flex flex-col md:flex-row justify-between w-full gap-6 md:gap-10 border-b pb-10">
        ...
        <div className="w-full flex flex-col md:flex-row items-start md:justify-end gap-6 md:gap-20 lg:gap-40">
          ...
          <div>
            ...
            <div className="text-sm space-y-2">
              <p>+1-234-567-890</p>
              <p style={{cursor:'pointer'}} onClick={()=>toast.success('Email copied!')}>contact@example.com</p>
            </div>
          </div>
        </div>
      </div>
