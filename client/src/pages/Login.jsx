    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-background)] px-4">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-extrabold text-gray-800 tracking-tight">{t('auth.welcomeBack')}</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="block text-sm font-semibold text-gray-700" htmlFor="password">{t('auth.password')}</label>
              <a href="#" className="text-xs font-semibold text-[var(--color-primary)] hover:text-green-800 transition-colors">{t('auth.forgotPassword')}</a>
            </div>
            <div className="relative">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-[var(--color-primary)] hover:bg-[#20401b] text-white py-3 rounded-lg text-sm font-bold transition-all shadow-md disabled:opacity-70"
          >
            {isSubmitting ? (
        ...
        <p className="mt-8 text-center text-sm text-gray-500 font-medium">
          {t('auth.noAccount')}{' '}
          <Link to="/register" className="text-[var(--color-primary)] hover:text-green-800 font-bold transition-colors">
            {t('auth.signUpFree')}
          </Link>
        </p>
      </motion.div>
